...
git clone https://github.com/your-username/my-birthday.git
cd my-birthday
...
├── public/
│   ├── audio/
│   │   └── *.mpeg               # Birthday audio clip
│   ├── favicon.svg              # 🎂 Custom cake favicon
│   └── icons.svg
│
├── src/
│   ├── App.jsx                  # Root — routing, skip modals, history API
│   ├── App.css                  # Global design tokens, stickers, modals
│   ├── Celebration.jsx          # Cake page — candles, audio, fanfare, confetti
│   ├── Celebration.css          # Cake page styles + animations
│   ├── Surprises.jsx            # 20 Wishes — envelope grid & letter cards
│   ├── Surprises.css            # Wishes page styles
